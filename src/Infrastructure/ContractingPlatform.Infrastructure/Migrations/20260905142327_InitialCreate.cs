        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    NationalIdOrIqama = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    District = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AddressDetails = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CoverageCities = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContractorProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedBudgetMin = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    ExpectedBudgetMax = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    DesiredExecutionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectRequests_ClientProfiles_ClientProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContractorServices_ContractorProfiles_ContractorProfileId",
                        column: x => x.ContractorProfileId,
                        principalTable: "ContractorProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContractorServices_ServiceItems_ServiceItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bids_ContractorProfiles_ContractorProfileId",
                        column: x => x.ContractorProfileId,
                        principalTable: "ContractorProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bids_ProjectRequests_ProjectRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectAttachments_ProjectRequests_ProjectRequestId",
                        column: x => x.ProjectRequestId,
                        principalTable: "ProjectRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProjectRequestId = table.Column<int>(type: "int", nullable: false),
                    AcceptedBidId = table.Column<int>(type: "int", nullable: false),
                    ClientProfileId = table.Column<int>(type: "int", nullable: false),
                    ContractorProfileId = table.Column<int>(type: "int", nullable: false),
                    ...
                    ContractorNetAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectContracts_Bids_AcceptedBidId",
                        column: x => x.AcceptedBidId,
                        principalTable: "Bids",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectContracts_ClientProfiles_ClientProfileId",
                        column: x => x.ClientProfileId,
                        principalTable: "ClientProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectContracts_ContractorProfiles_ContractorProfileId",
                        column: x => x.ContractorProfileId,
                        principalTable: "ContractorProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectContracts_ProjectRequests_ProjectRequestId",
                        column: x => x.ProjectRequestId,
                        principalTable: "ProjectRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatMessages_ProjectContracts_ProjectContractId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractorSubmissionNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContractorProofAttachmentUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClientApprovalNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectMilestones_ProjectContracts_ProjectContractId",
                        column: x => x.ProjectContractId,
                        principalTable: "ProjectContracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectReviews_ClientProfiles_ClientProfileId",
                        column: x => x.ClientProfileId,
                        principalTable: "ClientProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectReviews_ContractorProfiles_ContractorProfileId",
                        column: x => x.ContractorProfileId,
                        principalTable: "ContractorProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectReviews_ProjectContracts_ProjectContractId",
                        column: x => x.ProjectContractId,
                        principalTable: "ProjectContracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EscrowLockedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentTransactions_ClientProfiles_ClientProfileId",
                        column: x => x.ClientProfileId,
                        principalTable: "ClientProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentTransactions_ContractorProfiles_ContractorProfileId",
                        column: x => x.ContractorProfileId,
                        principalTable: "ContractorProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentTransactions_ProjectContracts_ProjectContractId",
                        column: x => x.ProjectContractId,
                        principalTable: "ProjectContracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentTransactions_ProjectMilestones_MilestoneId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bids_ProjectRequestId",
                table: "Bids",
                column: "ProjectRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_ProjectContractId",
                table: "ChatMessages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContractorServices_ContractorProfileId",
                table: "ContractorServices",
                column: "ContractorProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ContractorServices_ServiceItemId",
                table: "ContractorServices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransactions_ClientProfileId",
                table: "PaymentTransactions",
                column: "ClientProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransactions_ContractorProfileId",
                table: "PaymentTransactions",
                column: "ContractorProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransactions_ProjectContractId",
                table: "PaymentTransactions",
                column: "ProjectContractId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectAttachments_ProjectRequestId",
                table: "ProjectAttachments",
                column: "ProjectRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectContracts_AcceptedBidId",
                table: "ProjectContracts",
                column: "AcceptedBidId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProjectContracts_ClientProfileId",
                table: "ProjectContracts",
                column: "ClientProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectContracts_ContractorProfileId",
                table: "ProjectContracts",
                column: "ContractorProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectContracts_ProjectRequestId",
                table: "ProjectContracts",
                column: "ProjectRequestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProjectMilestones_ProjectContractId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectRequests_ClientProfileId",
                table: "ProjectRequests",
                column: "ClientProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectReviews_ClientProfileId",
                table: "ProjectReviews",
                column: "ClientProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectReviews_ContractorProfileId",
                table: "ProjectReviews",
                column: "ContractorProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectReviews_ProjectContractId",
                table: "ProjectReviews",
                column: "ProjectContractId",
                unique: true);
